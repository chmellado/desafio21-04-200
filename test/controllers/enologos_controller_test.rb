...
class EnologosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enologo" do
    assert_difference('Enologo.count') do
      post enologos_url, params: { enologo: { age: @enologo.age, name: @enologo.name, nationality: @enologo.nationality, revista: @enologo.revista } }
    end
  ...
  test "should update enologo" do
    patch enologo_url(@enologo), params: { enologo: { age: @enologo.age, name: @enologo.name, nationality: @enologo.nationality, revista: @enologo.revista } }
